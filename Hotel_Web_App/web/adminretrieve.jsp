...
<html>
    ...
    <body>
        ...
        <h2 style="text-align: center; margin-top: 50px; margin-bottom: 20px;"><b>Details of Admin</b></h2>
        
        <table style="width: 13%; border: 1px solid black; border-collapse: collapse; text-align: center ; margin-top: 100px; margin-bottom: 150px; align-content: center; margin-left: auto; margin-right: auto;">
            <tr>
                <th>Username</th>
                <th>Password</th>                
            </tr>
